...
const CreateRolePage = () => {
    ...
    const { permissions, fetchPermissions, createRole } = useRoles();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        const success = await createRole(roleName, selectedPermissions);
        setSubmitting(false);
    ...
    return (
        <div className="p-8 max-w-[1600px] mx-auto min-h-screen space-y-8">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-zinc-900 dark:text-white tracking-tight">Create New Role</h1>
                                ...
                                <div className="p-4 bg-zinc-50 dark:bg-white/5 rounded-xl border border-zinc-100 dark:border-white/5">
                                    <div className="flex gap-3">
                                        ...
                                        <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                                            Role names must be unique. Permissions assigned here determine what users with this role can access and modify within the system.
                                        </p>
                                    </div>
                                </div>
                            </div>
