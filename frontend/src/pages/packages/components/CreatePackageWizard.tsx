...
const packageSchema = z.object({
    ...
    basePrice: z.coerce.number().min(0, 'Price must be 0 or more').refine(val => !isNaN(val), { message: 'Base price is required' }),
...
const CreatePackageWizard: React.FC<CreatePackageWizardProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    const onSubmit: SubmitHandler<PackageFormData> = async (data) => {
        try {
            ...
            // Call the API to create the package
