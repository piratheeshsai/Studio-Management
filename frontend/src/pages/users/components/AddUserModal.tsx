...
import { X, Loader2, AlertCircle, RefreshCw, Copy, ChevronDown, Check } from 'lucide-react';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await api.post('/auth/users', {
                ...
                role: formData.role || (roles.length > 0 ? roles[0].name : 'OWNER'),
                mustChangePassword: formData.mustChangePassword
            });
            toast.success('User created successfully!', { id: toastId });
            onSuccess();
            setFormData({ name: '', email: '', password: '', role: '', mustChangePassword: false });
            onClose();
        } catch (err: any) {
            setStatus('idle');
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                />
                                <label htmlFor="forceChange" className="text-sm text-zinc-600 dark:text-zinc-400 select-none">
